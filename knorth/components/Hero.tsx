...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-screen pt-20 px-6 max-w-6xl mx-auto gap-y-16">
      
      {/* SECTION 1: "JUDGES A BOOK" (Kept exactly as you requested) */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start w-full">
        ...
        <div className="flex flex-col justify-center text-left w-full">
          <motion.div 
            ...
            className="text-4xl md:text-5xl font-medium mb-4 flex flex-wrap gap-2"
          >
            <span>I'm a</span>
          ...
          <div className="mb-8">
            <h3 className="text-xs uppercase tracking-widest font-bold mb-3 text-[#224766]">BASE IN PH</h3>
            <p className="text-foreground/60 mb-6 max-w-md leading-relaxed">
              ...
              I make meaningful and delightful digital products.
            </p>
        ...
        <div className="flex justify-center md:justify-end items-center w-full">
          <TiltedCard
            ...
            overlayContent={
              <div className="bg-white/10 backdrop-blur-md px-4 py-2 rounded-lg text-white text-[10px] border border-white/20">
                DEVELOPER
              </div>
            }
          />
