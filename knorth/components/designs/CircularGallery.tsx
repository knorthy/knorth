...
class App {
  ...
  createMedias(items: { image: string; text: string }[] | undefined, bend: number = 1, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      ...
      { image: `/logo/metacampus.png`, text: 'MetaCampus' },
      { image: `/logo/claro.png`, text: 'Claro' },
      { image: `/logo/homevision.png`, text: 'HomeVision' },
      { image: `https://picsum.photos/seed/5/800/600?grayscale`, text: 'DashCar Rentals' },
      { image: `/logo/psometric.png`, text: 'PsoMetric' },
      { image: `/logo/tbltbu.png`, text: 'TBLTBU' },
      { image: `/logo/oneindang.png`, text: 'OneIndang' },
