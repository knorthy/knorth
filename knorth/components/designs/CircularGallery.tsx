...
class App {
  ...
  createMedias(items: { image: string; text: string }[] | undefined, bend: number = 1, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      ...
      { image: `/metacampus.png`, text: 'MetaCampus' },
      { image: `/claro.png`, text: 'Claro' },
      { image: `/homevision.png`, text: 'HomeVision' },
      { image: `https://picsum.photos/seed/5/800/600?grayscale`, text: 'DashCar Rentals' },
      { image: `/psometric`, text: 'PsoMetric' },
      { image: `/tbltbu.png`, text: 'TBLTBU' },
      { image: `/oneindang.png`, text: 'OneIndang' },
