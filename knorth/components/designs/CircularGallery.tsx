...
class App {
  ...
  createMedias(items: { image: string; text: string }[] | undefined, bend: number = 1, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      ...
      { image: `/logo/5.png`, text: 'MetaCampus' },
      { image: `/logo/2.png`, text: 'Claro' },
      { image: `/logo/6.png`, text: 'HomeVision' },
      { image: `https://picsum.photos/seed/5/800/600?grayscale`, text: 'DashCar Rentals' },
      { image: `/logo/3.png`, text: 'PsoMetric' },
      { image: `/logo/4.png`, text: 'TBLTBU' },
      { image: `/logo/1.png`, text: 'OneIndang' },
